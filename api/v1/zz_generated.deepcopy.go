...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectiveDataOptions) DeepCopyInto(out *ObjectiveDataOptions) {
	*out = *in
	if in.Separator != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectiveDataOptions.
func (in *ObjectiveDataOptions) DeepCopy() *ObjectiveDataOptions {
	if in == nil {
		return nil
	}
	out := new(ObjectiveDataOptions)
