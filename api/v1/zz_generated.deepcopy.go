...
func (in *AzureAppConfigurationKeyValueOptions) DeepCopyInto(out *AzureAppConfigurationKeyValueOptions) {
	*out = *in
	if in.Selectors != nil {
		...
		*out = make([]KeyValueSelector, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeyValueSelector) DeepCopyInto(out *KeyValueSelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeyValueSelector.
func (in *KeyValueSelector) DeepCopy() *KeyValueSelector {
	if in == nil {
		return nil
	}
	out := new(KeyValueSelector)
	in.DeepCopyInto(out)
	return out
}
