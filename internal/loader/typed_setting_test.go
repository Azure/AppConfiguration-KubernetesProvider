...
func TestCreateFileStyleSettingsWithPropertiesFormat(t *testing.T) {
	key1Value := "value1"
	fileStyleSettingString1, err := createTypedSettings(map[string]*string{
		"key1": &key1Value,
	},
		map[string]bool{
			"key1": false,
	...
	emptyString := ""
	fileStyleSettingString2, err := createTypedSettings(map[string]*string{
		"empty": &emptyString,
	},
		map[string]bool{
			"empty": false,
	...
	fileStyleSettingString3, err := createTypedSettings(map[string]*string{
	...
	fileStyleSettingString4, err := createTypedSettings(map[string]*string{
		"jsonKey": &jsonKeyValue,
	},
		map[string]bool{
			"jsonKey": false,
	...
	fileStyleSettingString5, err := createTypedSettings(map[string]*string{
	...
	fileStyleSettingString6, err := createTypedSettings(map[string]*string{
	...
	fileStyleSettingString7, err := createTypedSettings(map[string]*string{
		"key1": nil,
	},
		map[string]bool{
			"key1": false,
	...
	assert.Equal(t, "", fileStyleSettingString7["test"])
	assert.Nil(t, err)

}

func TestCreateFileStyleSettings(t *testing.T) {
	fileStyleSettingString1, err := createTypedSettings(make(map[string]*string), make(map[string]bool), &acpv1.ConfigMapDataOptions{
		Type: acpv1.Yaml,
		Key:  "test",
	})
...
func TestPassedSettingIsNull(t *testing.T) {
	fileStyleSettingString1, err := createTypedSettings(nil, nil, &acpv1.ConfigMapDataOptions{
		Type: acpv1.Yaml,
		Key:  "test",
	})
	assert.NotNil(t, err)
...
func TestConfigMapDataOptionsIsNull(t *testing.T) {
	...
	settings, err := createTypedSettings(map[string]*string{
		"key1":         &key1Value,
...
func TestBuildHierarchicalSetting(t *testing.T) {
	...
	value2 = "value5"
	value3 = "{\"vKey1\":{\"vKey2\":\"value3\"}}"
	fileStyleSettingString8, err := createTypedSettings(map[string]*string{
		"key1.subKey3.0.test1": &value1,
		"key1.subKey3.1.test3": &value2,
	...
	value2 = "value4"
	value3 = "value3"
	fileStyleSettingString9, err := createTypedSettings(map[string]*string{
		"key1.subKey1":       &value1,
	...
	value2 = "value3"
	value3 = "value4"
	fileStyleSettingString10, err := createTypedSettings(map[string]*string{
		"key1.subKey1":       &value1,
	...
	value2 = "value3"
	value3 = "value4"
	fileStyleSettingString11, err := createTypedSettings(map[string]*string{
		"key1.subKey1":       &value1,
		"key1.subKey1.vKey1": &value2,
		"key1.subKey1.vKey2": &value3,
	},
	...
	value2 = "value3"
	fileStyleSettingString12, err := createTypedSettings(map[string]*string{
		"key1.subKey1":         &value1,
